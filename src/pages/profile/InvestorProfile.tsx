          ...
          <div className="sm:flex sm:space-x-6">
            ...
            <div className="mt-4 sm:mt-0 text-center sm:text-left w-full">
              {isEditing ? (
                ...
                <h1 className="text-2xl font-bold text-gray-900">{isCurrentUser ? currentUser?.name || investor.name : investor.name}</h1>
              )}
          ...
          <Card>
            ...
            <CardBody>
              {isEditing ? (
                ...
                <p className="text-gray-700">{isCurrentUser ? currentUser?.bio || investor.bio : investor.bio}</p>
              )}
            </CardBody>
          </Card>
